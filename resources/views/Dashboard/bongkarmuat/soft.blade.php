...
<div class="card">
    <div class="card-header">
        <h4 class="mt-5 text-center h1 fw-bolder">Data Bongkar Terhapus</h4>

        <div class="container d-flex mb-3">
            <form class="d-flex" role="search" method="GET" action="{{ route('bongkarmuat.search_trash') }}">
        ...
        <table class="table table-hover mt-2 table-bordered boder-primary rounded text-center shadow p-3 mb-5 rounded">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('bongkarmuat.restore', $data->id_bongkarmuat) }}" type="button" class="btn btn-outline-warning rounded-3">Restore</a>
                        ...
                        <div class="modal fade" id="hapusModal{{ $data->id_bongkarmuat }}" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{ route('bongkarmuat.delete', $data->id_bongkarmuat) }}">
                                        @csrf
