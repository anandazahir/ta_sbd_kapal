...
<div class="card">
    <div class="card-header">
        <h4 class="mt-5 text-center h1 fw-bolder">Data Barang Terhapus</h4>

        <div class="container d-flex mb-3">
            <form class="d-flex" role="search" method="GET" action="{{ route('barang.search_trash') }}">
        ...
        <table class="table table-hover mt-2 table-bordered boder-primary rounded text-center shadow p-3 mb-5 rounded">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('barang.restore', $data->id_barang) }}" type="button" class="btn btn-outline-warning rounded-3">Restore</a>
